...
*** Características
1. _Propósito distintivo:_ metas o conjunto de metas
...
+ *Sector primario:* extracción de materias primas.
...
+ *Sector cuaternario:* aspecto intelectual de la economía, investigación,
...
*** Definición
Es todo propósito humano que busca reunir e integrar recursos humanos
y no humanos para alcanzar los objetivos de auto-sostenimiento y de
lucro mediante la producción de bienes y servicios.
...
+ Asumen riegos
+ Dirigidas por una filosofía de negocio
...
** Administración
La administración como ciencia o técnica se centra en el diseño interno
de la empresa, de sus estructuras, procedimientos y sistemas de información
...
humanos de un organismo social; lograr su máxima eficiencia dentro de los
...
proporcionan el soporte y dirección de las líneas fundamentales
...
de control y formalización. Las estructuras pequeñas son más simples y
sus orientaciones están en la línea de la flexibilidad. El tamaño y la
...
+ *Moda:* Existen modas que en un determinado momento se hacen más
...
+ Los responsables de cada área tienen la percepción de que manejan una
  única unidad de negocio, con lo cual se piensa en el éxito territorial.
...
incertidumbre pero, sin embargo, el grado varía de una certeza relativa a
...
trabajadores y mejora las relaciones interpersonales con los empleados.

*** Modelo de liderazgo participativo de Vroom y Yetton :ATTACH:
Modelo normativo que proporciona un conjunto secuencial de reglas
que pretenden determinar la forma y cantidad de participación en la toma
de decisión, dependiendo de situación y la tarea.
[[attachment:_20220726_111910screenshot.png]]

*** Método 466 de Carreño Gomariz :ATTACH:
Es una herramienta práctica que permite a un líder determinar el
nivel de participación en la decisión de su equipo de colaboradores
directos.
[[attachment:_20220726_112009screenshot.png]]

** Sistemas de apoyo en la toma de decisiones
Un Sistema de Apoyo a las Decisiones (DSS por sus siglas en inglés
Decision Support System), es un sistema informático que sustenta el
proceso de toma de decisiones, lo cual implica la utilización de datos y
modelos para la generación, la estimación, la evaluación y/o la
comparación sistemática de alternativas, ayudando a los responsables de la
toma de decisión a reunir inteligencia, generar opciones y tomar
decisiones.

* Unidad 7: Control de gestión
** Qué es el control?
Consiste en la medición y corrección de las actividades empresariales a
fin de asegurar el logro de los objetivos y desarrollo de los planes de la
empresa.

** Actividades del control
+ Medir y corregir la actividad empresarial para adaptarse a los objetivos.
+ Cambiar los objetivos y planes si estos no se adaptan a la realidad del
  negocio.

** El control en el proceso administrativo
El control en el proceso administrativo representa la evaluación y
medición de la ejecución de los planes, con el fin de detectar y prever
desviaciones para establecer las medidas correctivas necesarias. Las
organizaciones deben tener control administrativo para garantizar su
correcto funcionamiento y eficiencia.

** El proceso de control
+ Establecer normas y métodos para medir el desempeño
+ Medir el desempeño
+ Tomar medidas correctivas y volver a evaluar
+ Retroalimentación

*** Control estratégico
Se encarga de medir la relación con el mercado, con la competencia, con
el entorno económico y los potenciales de la organización.
...
*** Control táctico
Se ocupa del control de relaciones entre funciones, de procesos, de
resultados de cada función y el control de asignación de recursos.
Se basa en la realización de presupuestos, planificación presupuestaria
a corto plazo (menos de un año), intenta asegurar que cada departamento
de la empresa en forma individual logren sus objetivos.

*** Control operativo
En este nivel de control las funciones son las relacionadas con la
ejecución de las tareas, rentabilidad, control financiero y la
eficiencia.
Dirige su acción hacia la planificación operativa, es decir, que asegura
que las tareas realizadas en cada puesto de trabajo día a día se
realicen correctamente.

** Tipos de control
*** Control preventivo
Orientados a prevenir desviaciones.

*** Control concurrente
Se realiza al mismo tiempo que la actividad que se controla.

*** Control correctivo
Se basa en el principio de retroalimentación. Las correcciones ocurren
luego de que se haya ejecutado la actividad.

** Puntos críticos
Puntos de un sistema en los que se deben vigilar o recopilar información.
...
** Áreas clave
Aspectos de una unidad que deben funcionar en forma eficaz para alcanzar
el éxito.

*** Centros de responsabilidad
**** Centros de ingresos
Relacionado con la actividad de ventas

**** Centros de costos
Relacionado con el circuito que sigue el producto hasta su venta
(abastecimiento, fabricación y distribución).

**** Centros de gastos
Relacionado con aquellos elementos de la estructura no relacionados
directamente con la generación de un bien o servicios.

**** Centros de beneficios
Engloba a los centros de ingresos, costos y/o gastos.

**** Centros de inversión
Engloban dentro de una noción más amplia a los centros de beneficios y
son susceptibles de realizar inversiones.

** Diseño de un sistema de control
*** Qué es un indicador?
Son unidades de medición que permiten evaluar el rendimiento de los
procesos internos de la organización.
En la medición del desempeño, los indicadores pueden servir para:
+ Proporcionan la base para supervisar y evaluar la iniciativa.
+ Definen metas que nos permiten conocer en qué medida se cumplen con
  los objetivos.
...
Definir las variables que van a componer el indicador, la relación que
tendrán entre sí y con ello la forma de cálculo. Dicha relación estará
dada por el tipo de información que se desea obtener. Así, un indicador
puede ser:
+ Absoluto
+ Razón
+ Tasa
...
la empresa comparándolas a las de la competencia, dando así
...
involucrando solo un proceso de punta a punta.
...
opción a realizar cualquier tipo de replanificación futura.
